...
const linkBase =
  'group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-muted transition-colors hover:bg-surface-2 hover:text-white'
const linkActive =
...
const navItems = [
  ...
  { to: ROUTES.analysis, label: 'AI Analysis', Icon: IconAnalysis },
